...
from hebrew.chars import HebrewChar, ALE
from metaphone import doublemetaphone
from hebrew_python import *
import csv
import codecs
import fmtlib
import smtplib
...
class Parser:
    ...
    def vfprintf_function(self):
        ...
        args = self.expr()
        self.eat(RPAREN)
        return fmtlib.vfprintf(stream, format_string, args)
    ...
    def vprintf_function(self):
        ...
        args = self.expr()
        self.eat(RPAREN)
        return fmtlib.vprintf(format_string, args)
    ...
    def vsprintf_function(self):
        ...
        args = self.expr()
        self.eat(RPAREN)
        return fmtlib.vsprintf(format_string, args)
